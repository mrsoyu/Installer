...
cd
#install tools/alat
wget https://raw.githubusercontent.com/mrsoyu/Installer/refs/heads/main/install-tools.sh && chmod +x install-tools.sh && ./install-tools.sh
#
#Instal Xray
wget https://raw.githubusercontent.com/mrsoyu/Installer/refs/heads/main/install-xray.sh && chmod +x install-xray.sh && ./install-xray.sh
#install xmenu
wget https://raw.githubusercontent.com/mrsoyu/Installer/refs/heads/main/menu/updatedll.sh && chmod +x updatedll.sh && ./updatedll.sh
#
#SELESAI
echo " "
